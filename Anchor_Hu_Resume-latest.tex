...
\item \textbf{Platform \& Tools:} Git, Linux, Docker, Amazon Web Services (AWS), Maven, Android Studio, Xcode
...
\resumeSubHeadingListStart
\resumeSubheading
{Software Development Engineer Intern \skill{TypeScript, React.js, Flask, Docker, SQL, JFrog, Tableau}}{Fremont, CA}
{\href{https://www.tesla.com/about}{\link{Tesla, Inc.}}}{June 2024 -- Sep. 2024}
\resumeItemListStart
\resumeItem{Maintained and enhanced \href{https://ziplabs.teslamotors.com/}{\link{Ziplabs}}, an in-house BI tool transitioned from Tableau, enabling advanced data analytics and seamless creation of charts and dashboards by directly connecting to Tesla databases.}
\resumeItem{Co-developed Ziplabs 2.0, a cutting-edge application integrating all features of its predecessor and introducing a comprehensive suite of AI tools, setting it apart from the \href{https://github.com/apache/superset/}{\link{Apache Superset}}-based Ziplabs 1.0.}
\resumeItem{Designed and implemented an in-house StackOverflow-like \href{https://ziplabs-qa.teslamotors.com/}{\link{QA platform}}, leveraging team's extensive maintenance experience, with comprehensive features and an AI search assistant, replacing the use of Tesla Mattermost discussion groups.}
\resumeItemListEnd
\resumeSubheading
